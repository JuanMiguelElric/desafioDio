    ...
    <div class="row justify-content-center py-3">
        <div class="col-12 col-md-4">
            <ul class="nav flex-column">
                <li class="nav-item">
                    <a href="#" class="fw-bold fs-3 nav-link" onclick="togglePrivacidade2()">Política de Privacidade</a> <br>
                </li>
                <li class="nav-item">
                    <a href="#" class="fw-bold fs-3 nav-link" onclick="toggleTermosDeUso2()">Termos de Uso</a> <br>
                </li>
            </ul>
        </div>
        <div class="col-12 col-md-8 politica d-block" id="privacidade2">
        ...
        <div class="col-12 col-md-8 politica d-none" id="termos-de-uso2">
...
<script>
    const toggleDisplay2 = (elementToShow, elementToHide) => {
    ...
    const togglePrivacidade2 = () => {
        const privacidade = document.querySelector('#privacidade2');
        const termosDeUso = document.querySelector('#termos-de-uso2');
        toggleDisplay2(privacidade, termosDeUso);
    };

    const toggleTermosDeUso2 = () => {
        const termosDeUso = document.querySelector('#termos-de-uso2');
        const privacidade = document.querySelector('#privacidade2');
        toggleDisplay2(termosDeUso, privacidade);
    };
</script>
@endsection