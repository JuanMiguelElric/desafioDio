        ...
        <div class="row">
            <div class="col-lg-12">
                <x-adminlte-card title="" theme="light" theme-mode="full" class="elevation-3 text-black"
                    ...
                    icon="" collapsible>
                    <form action="{{ route('contratos.update', $contrato->id) }}" method="POST" id="form">
                        @csrf
                        @method('PUT')
                        <div class="row justify-content-center">
                            <div class="col-md-6">
                                <x-adminlte-input name="numero_do_contrato" placeholder="" label="Número do contrato"
                                    value="{{ old('numero_do_contrato')??$contrato->numero_do_contrato }}" maxlength="255" required />

                                <x-adminlte-input name="objeto_do_contrato" placeholder="" label="Objeto do contrato"
                                    value="{{ old('objeto_do_contrato')??$contrato->objeto_do_contrato }}" maxlength="255" required />

                                <x-adminlte-input name="ano_do_fechamento_do_contrato" placeholder=""
                                    label="Ano do fechamento do contrato" value="{{ old('ano_do_fechamento_do_contrato')??$contrato->ano_do_fechamento_do_contrato }}"
                                ...
                                <x-adminlte-input name="responsavel_interno_do_contrato" placeholder=""
                                    ...
                                    value="{{ old('responsavel_interno_do_contrato')??$contrato->responsavel_interno_do_contrato }}" required />
