...
@section('content')
    <div class="container-fluid">
        ...
        <a href="{{ route('empresas.terceiros.create', ['empresa' => $empresa->id]) }}" class="btn btn-success mb-2">Adicionar
            terceiro</a> --}}
        ...
        <div class="row">
            <div class="col-md-12">
                @php
                    $heads = ['ID','CNPJ Terceiro', 'Nº contrato', 'Ano do contrato', 'Status', 'Due Diligence', 'Nível de risco', ['label' => 'Actions', 'no-export' => true, 'width' => 5]];

                    $config = [
                        'ajax' => [
                            'url' => route('contratos.indexall.json'),
                            'dataSrc' => 'contratos',
                            'type' => 'GET',
                        ...
                        'data' => [],
                        'order' => [[0, 'desc']],
                        'columns' => [['data' => 'id'],['data' => 't'], ['data' => 'n'], ['data' => 'a'], ['data' => 's'], ['data' => 'dd'], ['data' => 'nr'], ['data' => 'btns']],
                    ];
                @endphp
